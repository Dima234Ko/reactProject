  ...
  return (
    <div id="instructions">
      ...
      {showInstructions ? (
        ...
        <p className="warning-box">
          Для настройки камер у физических лиц выбираем количество портов и услугу "ФЛ"<br />
        ...
        <ul className="text">
          <li>Указываем данные и отправляем запрос</li>
        </ul>
        <p className="warning-box">
          Для настройки камеры БД
          NTU должна быть новая или сброшена. Сброс можно сделать на странице статус. 
          Остальные действия аналогичны, но выбираем "БД".
        </p>
      </div>
      )}
    </div>
