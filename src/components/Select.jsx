...
export function SelectSSID({ value, onChange }) {
  ...
  return <Select id="selectSSID2_4" options={options} value={value} onChange={onChange} />;
}

export function SelectSSID5({ value, onChange }) {
  const options = [
    "auto", "36", "40", "48", "44", "149", "153", "157", "161", "165"
  ];
  return <Select id="selectSSID5" options={options} value={value} onChange={onChange} />;
}
